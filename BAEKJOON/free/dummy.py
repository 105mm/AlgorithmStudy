...
while total_size_bytes > 0:
    ...
    file_size = random.randint(1, 53) * 1024 * 1024  # Bytes로 변환
    ...
    file_name = ''.join(random.choice(valid_chars) for _ in range(random.randint(25, 50))) + ".txt"
...
for file_name, file_size in files:
    ...
    print(output_line)
"""
# 결과를 선택한 드라이브 루트 디렉토리에 파일로 저장 44444444444444444444444
output_path = r"C:\Users\105mm\Desktop\dummy12\output.txt"
with open(output_path, "w") as f:
    for file_name, file_size in files:
        output_line = f"F:\\un\\{file_name}\t{str(file_size)}\t{'1'}\n" #444444444444444444444 
        f.write(output_line)
